...
// Helper method to draw the symbols.(We use attributedString before.)
...
//Drawing the circles using rectangles with really round corners
...
// Drawing the squiggles using a combination of curves
...
//Drawing the diamonds using just four lines
